...
def test_desktop_view(page, liveriga_base_url) -> None:
...
def test_tablet_view(page, liveriga_base_url) -> None:
...
def test_mobile_view(page, liveriga_base_url) -> None:
...
def test_mobile_menu_present(page, liveriga_base_url) -> None:
    page.set_viewport_size({"width": 375, "height": 667})
    open_home(page, liveriga_base_url)
    menu_button = page.get_by_role("button", name=lambda n: n and ("Menu" in n or "Izvēlne" in n))
